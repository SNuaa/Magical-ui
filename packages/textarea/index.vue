<template>
  <div :class="['mzl-textarea-default', customClass, { 'mzl-textarea-disabled': disabled }]">
    <textarea :form="form" :cols="cols" :rows="rows" :placeholder="placeholder" :maxlength="maxlength" :value="modelValue"
      @input="input" ref="textareaMzl" :disabled="disabled" :style="tStyle" @focus="focus" @blur="blur"
